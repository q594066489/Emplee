...
using Emploee.Sessions;
using Emploee.Web.Areas.Mpa.Models.Layout;
using Emploee.Web.Areas.Mpa.Startup;
using Emploee.Web.Controllers;
using Emploee.Web.Models.Layout;
using Emploee.Web.Session;
using HeaderViewModel = Emploee.Web.Areas.Mpa.Models.Layout.HeaderViewModel;

namespace Emploee.Web.Areas.Mpa.Controllers
{
    [AbpMvcAuthorize]
    public class LayoutController : EmploeeControllerBase
    {
