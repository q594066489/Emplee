...
(function ($) {
    ...
    BootstrapTable.COLUMN_DEFAULTS = {
        ...
        formData: {}, // 表单数据，前提条件 edit:true formData表单数据配置项
        //select : true/textarea : true/input : true, //自定义表单
        inputType: 'text',// 自定义表单类型
        // / 'checkbox'
        clazz: '', //自定义表单样式
            ...
            this.data = s ? $.grep(this.data, function (item, i) {
                for (var j = 0; j < that.header.fields.length; j++) {
                    ...
                    if (typeof key === 'string') {
                        ...
                        // Fix #142: respect searchForamtter booleanthis.options.totalRows
    ...
    BootstrapTable.prototype.initBody = function (fixedScroll) {
        ...
        this.$body.find('> tr[data-index] > td').off('click dblclick').on('click dblclick', function (e) {
            ...
            if (e.type === 'click' && that.options.clickToSelect && column.clickToSelect) {
                var $selectItem = $tr.find(sprintf(' name="%s"', (undefined === column.selectItemName ? that.options.selectItemName : column.selectItemName)));
    ...
    BootstrapTable.prototype.insertRowForm = function () {
        ...
        $.each($columns, function () {
            ...
            if (this.edit) {
                ...
                var $inputWidth = $formData.inputWidth;
                // 表单属性
                ...
                if ($visible) {
                    ...
                    if ($isSelect) {
                        ...
                        if (undefined == $inputType || $inputType == "text") {
                            ...
                            html.push(name);
                            html.push(clazz);
                            html.push("type='text'  style='width:" + $inputWidth + "px' />");
        ...
        $forms[$columns.length - 1] = "<a href='javascript:void(0);' title='delete' class='removeRowForm'><i class='fa fa-remove'></i></a>,";
    ...
    var allowedMethods = [
        ...
        'load', 'append', 'prepend', 'remove', 'removeAll','insertRowForm','updateRowForm','cancelRowForm',
