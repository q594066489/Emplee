...
(function () {
    $(function () {
        ...
        var _import = new app.ModalManager({
            viewUrl: abp.appPath + 'PersonInfoManage/ImportPersonManages',
            scriptUrl: abp.appPath + 'Views/PersonInfoManage/_ImportPersonManages.js',
