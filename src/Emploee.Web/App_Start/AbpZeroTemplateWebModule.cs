...
using Emploee.Web.App.Startup;//SPA!
using Emploee.Web.Areas.Mpa.Startup;//MPA!
using Emploee.Web.Bundling;
...
namespace Emploee.Web
{
    ...
    public class EmploeeWebModule : AbpModule
    {
