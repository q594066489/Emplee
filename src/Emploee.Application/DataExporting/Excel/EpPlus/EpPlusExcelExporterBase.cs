...
using Emploee.Dto;
using Emploee.Net.MimeTypes;
using OfficeOpenXml;

namespace Emploee.DataExporting.Excel.EpPlus
{
    public abstract class EpPlusExcelExporterBase : EmploeeServiceBase, ITransientDependency
    {
