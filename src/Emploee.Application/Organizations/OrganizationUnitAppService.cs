...
using Emploee.Organizations.Dto;
using System.Linq.Dynamic;

namespace Emploee.Organizations
{
    [AbpAuthorize(AppPermissions.Pages_Administration_OrganizationUnits)]
    public class OrganizationUnitAppService : EmploeeAppServiceBase, IOrganizationUnitAppService
    {
